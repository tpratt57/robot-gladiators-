...
var startGame = function()
{
  ...
  for (var i = 0; i < enemyNames.length; i++) 
  {
    if (playerHealth > 0) 
    {
      //displaying round player is in
      window.alert('Welcome to Robot Gladiators! Round ' + (i + 1));
      //pick enemy name based off index of enemyNames array
      var pickedEnemyName = enemyNames[i];
      //reset enemy health at start of new game 
      enemyHealth = 50;
      //sending pickedEnemyName into startGame function
